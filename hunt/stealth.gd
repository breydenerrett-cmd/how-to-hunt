...
static func movement_noise(a:Node3D) -> float:
 ...
 return clampf(base*clampf(a.visual_speed/speed,0,1)*surface,0,1)
static func detection(a:Node3D,distance:float,sight:bool,scent:bool) -> float:

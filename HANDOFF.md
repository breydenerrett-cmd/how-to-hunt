# Visual polish build — 0.1.5-hunt, 2026-09-08

Production checkpoint **ef3d619**, branch `codex/hunting-material-polish`. The full hunting goal remains active. This is a visual milestone, not the finished quality target. Godot4.5.2 standard/Compatibility, protocol2, schema1 and host-owned gameplay remain. Use matching0.1.5 versions for party play; previous releases and owner worlds remain intact.

**HUNT-17/18 first pass:** cooler cloud/sky colors, sky-derived ambient fill, restrained ACES grading and4x MSAA. Shared128px mipmapped color/normal/roughness maps distinguish timber, bark, stone, ground, fur, cloth, leather and metal. Local triplanar mapping keeps textures attached to moving objects. Batching separates explicit material families while retaining authored vertex colors, animated joints and exclusions. Physical shapes, identity, rewards and saves are unchanged. Foliage still uses the previous wind shader; this does not finish the environmental art pass. Initial timber was excessively striped and the scene too bright; grain, bump strength and light levels were reduced after rendered inspection. No Forward+, SSAO, volumetric fog or glow was enabled.

The inherited428669a interface checkpoint adds a shared theme and system-font fallback, with whole-interface scaling. It arrived during this session and must be included in final frozen-source renders and checks; earlier visual captures precede it. The inherited737cedf benchmark adds separate uncapped/capped passes. Early before_a/b samples used the older capped-only harness and are not used for an uncapped comparison. Matched before samples copy the same new harness onto22de945 runtime.

**Performance scope:** same Mac, Compatibility1920x1080, one idle hunter/five simulated deer. Matched prior-build uncapped medians17.373/7.182ms versus new7.008/7.011ms; baseline variance is too large to claim a causal speedup. New capped medians16.668/16.647ms and p9517.571/17.641ms. New samples report1475 drawcalls and about114MB tracked video memory versus prior1408–1440 draws/about65MB.4x MSAA and material separation have a measurable resource cost. These are short camp samples, not sustained60FPS, combat/co-op or weaker-machine acceptance. The owner0.1.3 app was left untouched; samples ran after it had closed. Background/minimized staged captures allow verification without interrupting an open playtest.

**Next priority:** reproduce and fix HUNT-21 hauling camera obstruction and HUNT-26 landmark/HUD overlap before adding new hauling mechanics. Then HUNT-15/16 changing wind/herd cues, HUNT-06 story and further woodland composition. Field dressing, predators, carts and additional wildlife remain plans. No purchases, publication, network/security changes or owner-save edits occurred. Evidence remains local and ignored. Frozen-source final checks and export/archive receipts follow below.
